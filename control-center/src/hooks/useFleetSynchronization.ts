    ...
    const loadControlPlane = async () => {
      try {
        ...
        setExecutionCapacity({
          ...
          sharedMarketEnabled: health.sharedMarketEnabled,
          sharedMarketConnected: health.sharedMarketConnected,
          sharedMarketGeneration: health.sharedMarketGeneration,
          sharedMarketBtcSnapshotAgeMs: health.sharedMarketBtcSnapshotAgeMs,
          sharedMarketEthSnapshotAgeMs: health.sharedMarketEthSnapshotAgeMs,
          sharedMarketRestFallbackCount: health.sharedMarketRestFallbackCount,
          sharedMarketReconnectCount: health.sharedMarketReconnectCount,
          sharedMarketWaitingPhaseCount: health.sharedMarketWaitingPhaseCount,
          sharedMarketSourceState: health.sharedMarketSourceState,
