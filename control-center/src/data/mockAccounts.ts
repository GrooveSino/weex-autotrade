...
export const mockAccounts: AccountInstance[] = [
  {
    ...
    strategyId: standardStrategy.id, strategy: standardStrategy, strategyProgress: strategyProgress('12780', 'holding', 480),
  },
  {
    ...
    strategyId: standardStrategy.id, strategy: standardStrategy, strategyProgress: strategyProgress('9400', 'cooldown', 840),
  },
  {
    ...
    strategyId: compactStrategy.id, strategy: compactStrategy, strategyProgress: strategyProgress('2800'),
  },
  {
    ...
    strategyId: compactStrategy.id, strategy: compactStrategy, strategyProgress: strategyProgress('0'),
  },
  {
  ...
  },
  {
    ...
    strategyId: standardStrategy.id, strategy: standardStrategy, strategyProgress: strategyProgress('0'),
  },
  {
    ...
    strategyId: overnightStrategy.id, strategy: overnightStrategy, strategyProgress: strategyProgress('8300', 'holding', 180),
  },
  {
    ...
    strategyId: overnightStrategy.id, strategy: overnightStrategy, strategyProgress: strategyProgress('9100', 'cooldown', 660),
  },
]
