...
import { selectPrimaryRuntimeWait } from './monitorRuntimeStage'
import { useMonitorReconciliation } from './useMonitorReconciliation'
...
export function LogDrawer({ account, sessionId = null, onClose }: LogDrawerProps) {
  ...
  const primaryRuntimeWait = selectPrimaryRuntimeWait(monitor?.activeWaits ?? [], serverNowMs)
  ...
  return <LogDrawerView
    ...
    primaryRuntimeWait={primaryRuntimeWait}
