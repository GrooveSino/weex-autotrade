...
from fleet_api.runtime.executor_process_metrics import process_snapshot
from fleet_api.services.control.service import FleetError, TelemetryUnavailable
...
def register_health_routes(app: FastAPI, ctx: FleetAppContext) -> None:
    ...
    def health() -> HealthResponse:
        ...
        return HealthResponse(
            ...
            shared_market_enabled=market_data.enabled,
            shared_market_connected=market_data.connected,
            shared_market_generation=market_data.generation,
            shared_market_btc_snapshot_age_ms=market_data.btc_snapshot_age_ms,
            shared_market_eth_snapshot_age_ms=market_data.eth_snapshot_age_ms,
            shared_market_rest_fallback_count=market_data.rest_fallback_count,
            shared_market_reconnect_count=market_data.reconnect_count,
            shared_market_waiting_phase_count=market_data.waiting_phase_count,
            shared_market_source_state=market_data.source_state,
