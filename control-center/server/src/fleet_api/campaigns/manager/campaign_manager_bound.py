...
from fleet_api.models import BetaCampaignPreview, BetaCampaignStatus, StrategyDirection, VolumeStrategy
...
def _preview_readiness(
    ...
    return {
        ...
        "blocking_positions": [dict(row) for row in boundary.get("blocking_positions", []) if isinstance(row, Mapping)],
