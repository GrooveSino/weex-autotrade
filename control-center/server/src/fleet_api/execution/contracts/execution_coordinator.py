...
from fleet_api.execution.contracts.execution_validation import (
    record_fills,
    snapshot_close_operation_id,
    validate_outcome,
    validate_position_close_outcome,
)
from fleet_api.models import InstanceStatus, StrategyStage
from fleet_api.runtime.telemetry import AccountTelemetryContext
from fleet_api.strategy.strategy import plan_strategy_cycle, random_seconds, target_progress_quote
