...
from ..support.test_api_support import create_payload, strategy_payload
...
def test_repeated_refresh_never_replaces_terminal_run_progress_with_zero() -> None:
    ...
    with TestClient(app) as api:
        ...
        snapshots.extend(api.post(f"/api/v1/instances/{instance['id']}/refresh").json() for _ in range(3))
